...
public class AnalyticsDaoImpl implements AnalyticsDao {
	...
	public List<ProjectSummary> getProjectSummariesByUserId(int userId) {
		...
		// Execute the SQL query and map the result to ProjectSummary objects
	 ...
	 *
	 * @param userId the ID of the user
	 * @return a list of ModuleSummary objects
	 */
	public List<ModuleSummary> getModuleSummariesByUserId(int userId) {
		...
		// Execute the SQL query and map the result to ModuleSummary objects
		List<ModuleSummary> moduleSummaries = jdbcTemplate.query(sql, new Object[] { userId }, (rs, rowNum) -> {
			...
			summary.setTotalWorkingHours(Math.abs(rs.getDouble("total_working_hours"))); // Use Math.abs() to convert to positive
			return summary;
		});
	 ...
	 *
	 * @param userId the ID of the user
	 * @return a list of TaskSummary objects
	 */
	public List<TaskSummary> getTaskSummariesByUserId(int userId) {
		...
		// Execute the SQL query and map the result to TaskSummary objects
	 ...
	 *
	 * @param userId the ID of the user
	 * @return a list of SubtaskSummary objects
	 */
	public List<SubtaskSummary> getSubtaskSummariesByUserId(int userId) {
		...
		// Execute the SQL query and map the result to SubtaskSummary objects
	 ...
	 *
	 * @return a list of Past30CompletionSummary objects
	 */
	public List<Past30CompletionSummary> getPast30CompletionSummaries() {
		...
		// Execute the SQL query and map the result to Past30CompletionSummary objects
